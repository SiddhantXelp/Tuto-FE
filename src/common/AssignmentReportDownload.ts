...
const pdfTemplate = (data: {
  ...
  <div class="bg-white w-full border border-gray-300 rounded-lg p-10 box-border font-sans text-gray-800 shadow-lg">
    <h1 class="text-center text-4xl text-blue-600 mb-8 font-bold">Assignment Report</h1>

    <h2 class="text-3xl text-gray-800 mb-10 font-semibold">Assignment Details</h2> 
    ...
    <h2 class="text-3xl text-gray-800 mb-10 font-semibold">Assignment Materials</h2>
