...
// type SubTab = 'StudentClassDetails';
...
//       setSelectedTab(tabs);
//     }
//     if (subTabs && ['StudentClassDetails', 'Attendance'].includes(subTabs)) {
//       setSelectedSubTab(subTabs);
//     }
//   }, [tabs, subTabs]);

//   useEffect(() => {
//     router.push(`?tab=${selectedTab}&subTab=${selectedSubTab}`);
...
//             {selectedSubTab === 'StudentClassDetails' ? <StudentClassDetails /> : <Attendance />}
//           </div>
//         );
//       default:
//         return null;
