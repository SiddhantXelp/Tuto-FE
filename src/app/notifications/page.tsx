...
//            <span onClick={toggleWidth} className="text-xl  font-semibold whitespace-nowrap">
...
//             <div key={notification.id} className="flex items-start p-4 border-b border-[#dfdbdb] ">
  ...
  return (
    ...
    <div className="relative" >
      ...
      >
       ...
       <p onClick={Cancel} className='cursor-pointer m-5'><RxCross1 size={20}/></p>
