...
const MyFilesPage = () => {
    ...
    const subFileId = Number(id);

    const subFile = file?.subFiles?.find(subFile => subFile.id === subFileId);
            ...
            <div className="p-4 md:p-8 bg-white h-[100rem] rounded-xl">
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8">
                    <div className="flex items-center space-x-4 p-4 md:p-6 border-grey border-b-[1px]">
                        ...
                        <div>
                            <h1 className="text-lg md:text-xl font-semibold text-[#565656]">{subFile?.subFilename}</h1>
                            <p className="text-gray-600">
                                {subFile?.totalFiles} files
                            </p>
                        </div>
                        <BsThreeDotsVertical
                            size={20}
