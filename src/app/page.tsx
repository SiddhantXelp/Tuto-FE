    ...
    <>
          ...
          <div>
            ...
            <div className="sm:w-30 md:w-20 lg:w-32 xl:w-48 2xl:w-52 h-32 bg-white shadow-lg rounded-xl p-2">
              <ul className="list-disc pl-5" >
                <li className="text-buttonGray text-xxs break-words">
                  200 students
                </li>
              </ul>
              <ul className="ml-5 flex flex-col mt-2">
                <li className="text-buttonGray text-xxxs" >144 Active students</li>
                <li className="text-buttonGray text-xxxs">14 Newly registered</li>
              </ul>
          ...
          <div>
            ...
            <div className="sm:w-30 md:w-20 lg:w-32 xl:w-48 2xl:w-52 h-32 bg-white shadow-lg rounded-xl p-2">
              ...
              <ul className="ml-5 flex flex-col">
                <li className="text-buttonGray text-xxxs">2 classes available</li>
              </ul>
              <div className="flex justify-end mt-10">
          ...
          <div>
            ...
            <div className="sm:w-30 md:w-20 lg:w-32 xl:w-48 2xl:w-52 h-32 bg-white shadow-lg rounded-xl p-2">
              <div className="flex flex-row  gap-4 align-middle">
                ...
                <span className="text-buttonGray text-xxxs">18:30 - 20:30</span>
              </div>
              <div className="flex flex-row  gap-4 align-middle mt-3">
                <span className="mt-0"><FaBook size={10} color="gray" /></span>
                <span className="text-buttonGray text-xxxs">English class</span>
              </div>
            </div>
          </div>
          <div>
            <span className="text-buttonGray sm:text-xxs md:text-xxs">Next Class</span>
            <div className="sm:w-30 md:w-20 lg:w-32 xl:w-48 2xl:w-52 h-32 bg-white shadow-lg rounded-xl p-2">
              <div className="flex flex-row  gap-4 align-middle">
                <span className="mt-0"><FaRegClock size={10} color="gray" /></span>
                <span className="text-buttonGray text-xxs">18:30 - 20:30</span>
              </div>
              <div className="flex flex-row  gap-4 align-middle mt-3">
                <span className="mt-0"><FaBook size={10} color="gray" /></span>
                <span className="text-buttonGray text-xxs">English class</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-[40%_60%] mt-10 gap-2 2xl:gap-10">
          <div className="flex flex-col gap-4 ml-6">
            ...
            <button className='sm:w-20 md:w-16 lg:w-20 xl:w-36 2xl:w-44   md:h-6 lg:h-8 xl:h-10 2xl:h-12 bg-gray-400 flex justify-center items-center border rounded-2xl  p-1'>
              <span className='text-white text-xxs'>Schedule </span>
            </button>
          </div>
          <div className="flex flex-col items-center">
            <div className="md:w-20 lg:w-20 xl:w-24 md:h-20 lg:h-20 xl:h-24  bg-red-400 rounded-full overflow-hidden">
              <Image
                src="/home/xelpmoc/Pictures/Screenshots/Screenshot from 2024-06-21 14-36-43.png"
            ...
            <span className="text-buttonGray text-xxxs ">Hello</span>
            <span className="text-buttonGray text-xxs ">Ramana reddy</span>
          </div>
        </div>
      </div>
      ...
      <div className="border-dashed border  w-full h-64 rounded-lg">
        <div className="grid grid-cols-[70%_30%] gap-2">
          ...
          <div className=" sm:w-20 md:w-full lg:w-full xl:w-full 2xl:w-full bg-white shadow-lg  border-white mt-2">
            <Calendar
              onChange={setValue}
              value={value}
              locale="en-US"
              ...
              <div className="p-4">
                {data.map((item) => (
                  <div className="bg-white border-2 border-gray-300 p-2 flex flex-col gap-1 rounded-lg mt-1">
                    <span className="text-buttonGray text-xxs">{item.head}</span>
                    <span className="text-buttonGray text-xxxs">{item.time}</span>
                  </div>
                ))}
              </div>
