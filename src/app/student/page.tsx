...
const StudentPage: React.FC = () => {
  ...
  return (
    <div className='w-full h-auto'>
      ...
      <div className='flex flex-row sm:gap-2 md:gap-4 lg:gap-6 mt-10 '>
        {data.map((item, index) => (
          <div className={(index === 0 || index === 2) ? 'cursor-pointer' : ''} key={index} onClick={() => (index === 0 || index === 2) && handleClick(index)}>
            ...
            <div className='flex flex-wrap gap-4 items-center '>
              <div className='md:w-32 lg:w-38 xl:w-56 2xl:w-48 h-30 bg-buttonGray border rounded-md flex flex-col justify-between p-4'>
                <div>
        ...
        <div className='w-32 h-30 bg-buttonGray border rounded-md mt-6 flex items-center justify-center'>
