...
const SplashScreen: React.FC = () => {
  ...
  const renderContent = () => {
    switch (step) {
      case 1:
        return (
          <div>
            <h2 className="text-xl font-medium mb-6  flex justify-center">Hello {role}</h2>
      ...
      case 2:
        return (
          <div>
            <h2 className="text-2xl font-medium mb-6 flex justify-center">Hello {role}</h2>
            <p className="text-gray-700 mb-8 mt-20">
  ...
  return (
    <div className="min-h-screen flex flex-col bg-blue-50 relative">
      <div className="w-full h-14 bg-white flex justify-start items-center pl-4" style={{ boxShadow: "0px 3px 6px #00000029" }}>
        <span className="text-[#8A70D6] text-lg">TutorNow</span>
      </div>
      <div className="flex-grow flex flex-col items-center justify-center">
        <div className="w-4/5 md:w-1/2 bg-white rounded-lg shadow-lg p-16 flex flex-col border border-primaryColor text-center " style={{ minHeight: '500px' }}>
